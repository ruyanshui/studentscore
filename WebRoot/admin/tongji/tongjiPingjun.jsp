...
<body leftmargin="2" topmargin="2"
	...
	<form action="<%=path%>/tongji?type=tongjiPingjun" name="formAdd"
		method="post">
	...
	<div id="line" style="width:98%;height:400px;"></div>
	<script type="text/javascript">
		...
		myChart2.setOption({
			title: {text:  '${requestScope.dateinfo} 平均成绩曲线分析'},
