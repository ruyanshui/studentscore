...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <script language="javascript">
           ...
           function specialtyAll()
           {
               if(i==0)
               {
                   ...
                   loginService.specialtyAll(callback);
                   i=1;
               }
           ...
           function callback(data)
           {
               ...
               DWRUtil.addOptions("specialty_id",data,"id","name");
           }
           
           function check()
           {
               if(document.formAdd.specialty_id.value==0)
               { 
                   alert("请选择专业");
                   return false;
               }
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif'>
			<form action="<%=path %>/classes?type=classesEdit" name="formAdd" method="post">
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <table border="0">
							           <tr> 
							               <td>  
							                  <select name="specialty_id" id="specialty_id" onclick="specialtyAll()">
