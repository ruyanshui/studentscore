...
%>
<%-- <% String data = (String)request.getAttribute("spiritStateList"); %> --%>
...
<body leftmargin="2" topmargin="2" background='<%=path%>/images/allbg.gif'>
    <form action="<%=path%>/report?type=schoolReport" name="schoolReport" method="post">
    日期
   ...
   // 考勤表格
   var resultAttendenceData = ${resultList} 
   console.log("resultAttendenceData: " ,resultAttendenceData)
    var feelingData = ${feelingList}
    var happy ;
    var diluo;
    var normal ;
    ...
    // 人际关系
    var relationShipListData = ${relationShipList};
    var alone ;
    var verygood;
    var good;
    var normal1;
    ...
    // 学习状态
    var learningData = ${learningStateList};
    ...
    // 精神
    var spiritStateList = ${spiritStateList};
    ...
    var subjectInterestData = ${subjectInterestList}
    ...
    // 情绪不佳
    var qingxubujiaData = ${qingxubujia};
    var xuexizhuangtaibujiaData = ${xuexizhuangtaibujia};
    var jingshenzhuangtaibujiaData = ${jingshenzhuangtaibujia};
